...
echo "-------------------------------------------------"
echo "       Setup Language to PT and set locale       "
echo "-------------------------------------------------"
sed -i 's/^#pt_PT.UTF-8 UTF-8/pt_PT.UTF-8 UTF-8/' /etc/locale.gen
locale-gen
timedatectl --no-ask-password set-timezone Europe/Lisbon
timedatectl --no-ask-password set-ntp 1
localectl --no-ask-password set-locale LANG="pt_PT.UTF-8" LC_COLLATE="" LC_TIME="pt_PT.UTF-8"
